...
public class AnimationIdleAction implements Action {
    ...
    public AnimationIdleAction(AbstractEntity entity, float frameDuration, TextureRegion[] keyFrames) throws ComponentMissingException {
