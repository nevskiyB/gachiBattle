...
public class AnimationWalkRightAction implements Action {
    private final ViewComponent viewComponent;
    private final Animation<TextureRegion> animation;
    private float stateTime = 0f;
    public boolean enabled = true;

    public AnimationWalkRightAction(AbstractEntity entity, float frameDuration, TextureRegion[] keyFrames) throws ComponentMissingException {
